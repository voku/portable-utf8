...
<p>
  ...
  public function testSubstrCount()
  {
    ...
    if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
      self::assertSame(false, substr_count('', '', ''));  // offset (int) is encoding (string) :/
    } else {
    ...
    if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
      self::assertSame(false, substr_count('', 'test', '1')); // offset (int) is encoding (string) + last parameter is not available :/
    } else {
    ...
    if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
      self::assertSame(false, substr_count('test', 'test', '1')); // offset (int) is encoding (string) + last parameter is not available :/
    } else {
    ...
    if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
      self::assertSame(false, substr_count((string)12345, (string)23, (string)1)); // offset (int) is encoding (string) + last parameter is not available :/
    } else {
    ...
    if (Bootup::is_php('7.1') === false) {
      ...
      if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
        self::assertSame(false, substr_count('abcde', 'de', (string)-2)); // offset (int) is encoding (string) + last parameter is not available :/
      } else {
    ...
    if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
      self::assertSame(false, substr_count('abcde', 'bcg', (string)1)); // offset (int) is encoding (string) + last parameter is not available :/
    } else {
    ...
    if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
      self::assertSame(false, substr_count('abcde', 'BC', (string)1)); // offset (int) is encoding (string) + last parameter is not available :/
    } else {
    ...
    if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
      self::assertSame(false, substr_count('abcde', 'cd', (string)1)); // offset (int) is encoding (string) + last parameter is not available :/
    } else {
